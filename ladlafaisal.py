...
os.system('clear')
psb('\x1b[1;32mBANGLADESH FAISAL SHEHZAD X LADLA BACHA 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : ғαιsαℓ sнεнzα∂ x ℓα∂ℓα вαcнα'
    print 'FACEBOOK : https://www.facebook.com/profile.php?id=100028496555340'
    print 'GITHUB     : github.com/HunterFaisalshah007'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
